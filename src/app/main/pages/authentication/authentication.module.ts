...
import { LocckScreenComponent } from "./locck-screen/locck-screen.component";
...
@NgModule({
  declarations: [AuthLoginV2Component, AuthRegisterV2Component, AuthForgotPasswordV2Component, AuthResetPasswordV2Component, LocckScreenComponent],
  imports: [CommonModule, RouterModule.forChild(routes), NgbModule, FormsModule, ReactiveFormsModule, CoreCommonModule],
  exports: [LocckScreenComponent],
})

...
export class AcademicYearComponent implements OnInit {
  ...
  constructor(public apiService:ApiService,private dialog: DialogService, public spinner:SpinnerService, public toster:ToastrService,public dialogRef: MatDialogRef<AcademicYearComponent>) { }
  ...
  UpdateAy(){
    ...
    this.apiService.postTypeRequest("update_academic_status",data).subscribe((result:any)=>{
      if(result.result){
  ...
  onAddNewAy(){
    ...
    if(this.ayeditValue.length > 0){
      ...
      this.apiService.postTypeRequest('register_new_item/ACADEMIC_YEAR',div).subscribe((result:any) => {
        if(result.result){
          this.ay = result.data
          this.ayList = result.data
          this.ngOnInit();

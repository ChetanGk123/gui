...
const routes: Routes = [
  ...
  { path: 'demoAuth', loadChildren: () => import('./components/authentication/authentication.module').then(m => m.AuthenticationModule) },
  { path: 'institute', loadChildren: () => import('./components/institute/institute.module').then(m => m.InstituteModule) },

...
export class AuthService {
  ...
  constructor(private http: HttpClient, private route: ActivatedRoute, public router: Router, public toster: ToastrService, private cookieService: CookieService, public spinnerService: SpinnerService, public ApiService: ApiService) {}
